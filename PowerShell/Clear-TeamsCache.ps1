<#
	.SYNOPSIS
	Closes Teams, Chrome, and Edge / IE (heathen), then clears the caches for each before restarting them
	
	.DESCRIPTION
	This script is useful for clearing out little glitches and issues with Teams, as well as pushing any changes that may not have synced yet (i.e. job title changes, user avatars, etc.)
	
	.EXAMPLE
	Not required, this script runs as is, with no need for parameters
#>
